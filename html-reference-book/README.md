# The Complete HTML Reference Book (with CSS)

A reference book for HTML 1, 2.0, 3.2, 4.01, XHTML, HTML5 and the Living Standard, plus a CSS part.

| File | What it is |
|------|------------|
| `HTML-Reference-Book.pdf` | The printable book (10,000+ pages, A5, bookmarks + table of contents + index). Search with Ctrl+F. |
...
5. Event handler attributes (one page each)  6. Element reference: 144 elements, every attribute explained
...
12. HTML & CSS course: 36 lessons following the W3Schools HTML and CSS tutorial, ending with a complete landing-page project
13. Practical guides  14. Glossary and index
15. **Practice projects**: 1,125 complete projects (45 page types x 25 businesses), each with brief, goals, build guide, full `index.html` + `styles.css`, line-by-line explanation, checklist and exercises
