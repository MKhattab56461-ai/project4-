...
| File | What it is |
|------|------------|
| `HTML-Reference-Book.pdf` | The printable book (2000+ pages, A5, bookmarks + table of contents + index). Search with Ctrl+F. |
...
11. CSS: fundamentals, selectors, properties, styling cookbook, lists and tables with CSS
12. Practical guides  13. Glossary and index
